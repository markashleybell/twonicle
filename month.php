...
<html>
    ...
    <body>
        ...
        <div id="container">
            <div id="navigation">
                <?php echo draw_month($_GET['y'], $_GET['m'], 0, '/' . $basepath, $db->getDailyTweetCountsForMonth($_GET['y'], $_GET['m']), $db->getMaxTweetsInDayForMonth($_GET['y'], $_GET['m'])); ?>
                <?php require('include/year_navigation.php'); ?>
            </div>
            <div id="tweets-<?php echo $_GET['y'] . '-' . $_GET['m'] . '-00'; ?>" class="tweets">
                <?php
